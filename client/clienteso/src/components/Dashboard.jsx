          ...
          <tbody>
            {missions.map((mission) => (
              <tr key={mission.ID} className="hover:bg-gray-50">
                ...
                <td className="border px-4 py-2">{mission.destination}</td>
                <td className="border px-4 py-2">{mission.launchDate}</td>
                <td className="border px-4 py-2">{mission.status}</td>
